<?php $titulo = 'Editar Sanción - Biblioteca Escolar'; ?>
<?php require __DIR__ . '/../header.php'; ?>

<h1>Editar sancion</h1>

<form action="index.php?route=sanciones/update&id=<?= $datos['id'] ?>" method="POST" class="formulario" novalidate id="form-sancion">
    ...
    <div class="acciones-form">
        <button type="submit" class="btn btn-primary">Actualizar sancion</button>
