<?php $titulo = 'Nuevo(a) Editorial - Biblioteca Escolar'; ?>
<?php require __DIR__ . '/../header.php'; ?>

<h1>Registrar editorial</h1>

<form action="index.php?route=editoriales/store" method="POST" class="formulario" novalidate id="form-editorial">
