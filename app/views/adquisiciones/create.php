<?php $titulo = 'Nuevo(a) Adquisición - Biblioteca Escolar'; ?>
<?php require __DIR__ . '/../header.php'; ?>

<h1>Registrar adquisicion</h1>

<form action="index.php?route=adquisiciones/store" method="POST" class="formulario" novalidate id="form-adquisicion">
    ...
    <div class="acciones-form">
        <button type="submit" class="btn btn-primary">Guardar adquisicion</button>
