<?php $titulo = 'Editar Estudiante - Biblioteca Escolar'; ?>
<?php require __DIR__ . '/../header.php'; ?>

<h1>Editar estudiante</h1>

<form action="index.php?route=estudiantes/update&id=<?= $datos['id'] ?>" method="POST" class="formulario" novalidate id="form-estudiante">
