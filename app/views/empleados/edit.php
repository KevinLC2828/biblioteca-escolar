<?php $titulo = 'Editar Empleado - Biblioteca Escolar'; ?>
<?php require __DIR__ . '/../header.php'; ?>

<h1>Editar empleado</h1>

<form action="index.php?route=empleados/update&id=<?= $datos['id'] ?>" method="POST" class="formulario" novalidate id="form-empleado">
